...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_data_path",default = r"../data/0615data/test/low",type = str,help = "path of test low seismic images with noise")
    parser.add_argument("--test_target_path",default = "../data/0615data/test/high",type = str,help = "path of test high seismic images without noise")
    parser.add_argument("--model_path",default = r"../result/SRF_2/model/netG_epoch_100.pth",type = str,help = "pre_trained model use for test")

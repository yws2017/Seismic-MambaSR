...
from model import Seismic_MambaSR
...
def main(opt):
    ...
    netG = Seismic_MambaSR()
    print('# generator parameters:', sum(param.numel() for param in netG.parameters()))

    # loss of generator
    generator_criterion = GeneratorLoss(perception_index = PECP_INDEX)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_epochs",default = 250,type = int,help = "train epoch number")
    parser.add_argument("--lr_data_train", default = "../data/0615data/train/low", type=str, help="low resolution data path of train set")
    parser.add_argument("--hr_data_train", default = "../data/0615data/train/high", type=str, help="high resolution data path of train set")
    parser.add_argument("--lr_data_val", default = "../data/0615data/val/low", type=str, help="low resolution data path of val set")
    parser.add_argument("--hr_data_val", default = "../data/0615data/val/high", type=str, help="high resolution data path of val set")
